...
export default function Header() {
	...
	useEffect(() => {
		const targetDate = new Date("2025-02-26T00:00:00+07:00");
			...
			<div className="flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto">
				<div className="lg:w-3/5 text-center lg:text-left">
					...
					<p className="mt-4 text-sm sm:text-base lg:text-lg">
						Project X Vietnam officially launch our annual Summer Fellowship
						Program for 2025 with the mission of &quot;Moving forward the next
						generation of tech youth&quot;.
					</p>
