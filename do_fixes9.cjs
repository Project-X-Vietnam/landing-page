...
t = t.replace('At mid-level, your CV should show impact, not just activity. I.m not looking for what you did day-to-day — I want to know what changed because of your work. Quantify your impact wherever possible.', 'Your CV should focus on your potential, what you did, and what you achieved. I\\'m not looking for a seasoned expert, but I want to see your drive and ability to learn quickly.');
t = t.replace('Mid-Level', 'Junior / Intern');
