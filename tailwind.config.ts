  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        "md3-serif": ["Newsreader", "serif"],
        "md3-sans": ["Inter", "sans-serif"],
        "md3-mono": ["Space Grotesk", "monospace"]
      },
      colors: {
