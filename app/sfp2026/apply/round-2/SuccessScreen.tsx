...
const TIMELINE_STEPS = [
  {
    ...
    desc: "Our team reviews your skills profile and availability.",
  ...
  },
  {
    ...
    title: "SFP 2026 Kickoff",
    desc: "Selected fellows begin the Summer Fellowship Program.",
    time: "Summer 2026",
  },
];
...
export default function SuccessScreen({ firstName, email }: SuccessScreenProps) {
    ...
    >
      ...
      <div className="relative z-10 max-w-[440px] w-full">
        ...
        <motion.p {...fade(0.65)} className="text-center text-white/75 text-[15px] leading-relaxed mb-10 max-w-sm mx-auto">
          Your <span className="text-secondary font-semibold">Round 2</span> application
